...
<body class="min-h-screen flex flex-col justify-between overflow-x-hidden selection:bg-cyan-500/30 selection:text-cyan-200">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <span class="text-[10px] block text-cyan-500 font-mono tracking-widest uppercase">AI Secure-Data Shield</span>
                </div>
            </div>
            ...
            <?php if (\App\Core\Session::has('user') && \App\Core\Session::get('mfa_verified') === true): ?>
                ...
                <nav class="flex items-center space-x-6">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <!-- Logout Action -->
                        <a href="<?= APP_URL ?>/logout" class="bg-red-50 text-red-650 border border-red-100 hover:bg-red-500 hover:text-white hover:border-red-500 p-2 rounded-lg transition-all" title="Logout Securely">
    ...
    <footer class="border-t border-cyan-500/10 bg-cyber-dark/60 py-6 text-center text-xs text-gray-500">
        <div class="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
            <div>
                &copy; 2026 GSM Guard Corp. Built with enterprise-grade cryptography.
            </div>
            <div class="flex space-x-4 font-mono text-[10px]">
                <span class="flex items-center space-x-1"><span class="w-2 h-2 rounded-full bg-emerald-500 animate-ping"></span><span class="text-emerald-400">AES-256-CBC Enabled</span></span>
                <span class="text-cyan-500">OpenSSL 1.1.1+</span>
                <span class="text-purple-400">AI behavioral analysis active</span>
            </div>
        </div>
    </footer>
