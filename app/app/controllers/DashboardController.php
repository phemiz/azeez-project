...
class DashboardController extends Controller {
    ...
    public function index(): void {
        ...
        // Fetch user encrypted messages
        $messages = $this->db->fetchAll(
            "SELECT * FROM encrypted_messages WHERE sender_id = ? ORDER BY created_at DESC LIMIT 10",
            [$user['id']]
        );
    ...
    public function showDecrypt(): void {
        ...
        // Fetch user message envelope history for parameter populating
        $messages = $this->db->fetchAll(
            "SELECT * FROM encrypted_messages WHERE sender_id = ? ORDER BY created_at DESC LIMIT 10",
            [$user['id']]
        );
