...
// 5. Execute Global Security Headers and Dispatch Route
...
$securityMiddleware->handle(function() use ($router) {
    ...
    // e.g. APP_URL = "http://localhost/gsm-security"  →  basePath = "/gsm-security"
    // REQUEST_URI  = "/gsm-security/login"             →  routed as  "/login"
